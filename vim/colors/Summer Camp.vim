" Vim color file
" Converted from Textmate theme Summer Camp using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi Visual ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1e1b12 gui=NONE
...
hi PmenuSel ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1e1b12 gui=NONE
...
hi Comment ctermfg=16 ctermbg=16 cterm=NONE guifg=#2b2719 guibg=#16140d gui=italic
...
hi Todo ctermfg=16 ctermbg=16 cterm=inverse,bold guifg=#2b2719 guibg=#16140d gui=inverse,bold,italic
...
hi erubyComment ctermfg=16 ctermbg=16 cterm=NONE guifg=#2b2719 guibg=#16140d gui=italic
