" Vim color file
" Converted from Textmate theme Vibrant Fin using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi MatchParen ctermfg=202 ctermbg=NONE cterm=NONE guifg=#ff6600 guibg=NONE gui=NONE
...
hi IncSearch ctermfg=NONE ctermbg=52 cterm=NONE guifg=NONE guibg=#542200 gui=NONE
hi Search ctermfg=NONE ctermbg=52 cterm=NONE guifg=NONE guibg=#542200 gui=NONE
hi Directory ctermfg=66 ctermbg=NONE cterm=NONE guifg=#339999 guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=0 cterm=NONE guifg=#634d70 guibg=#000000 gui=NONE
...
hi Comment ctermfg=59 ctermbg=NONE cterm=NONE guifg=#634d70 guibg=NONE gui=NONE
...
hi Todo ctermfg=59 ctermbg=NONE cterm=inverse,bold guifg=#634d70 guibg=NONE gui=inverse,bold
...
hi erubyComment ctermfg=59 ctermbg=NONE cterm=NONE guifg=#634d70 guibg=NONE gui=NONE
