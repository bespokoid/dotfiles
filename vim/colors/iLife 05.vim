...
hi MatchParen ctermfg=0 ctermbg=231 cterm=bold guifg=#000000 guibg=#fffdfd gui=bold
...
hi IncSearch ctermfg=NONE ctermbg=152 cterm=NONE guifg=NONE guibg=#bbd5dc gui=NONE
hi Search ctermfg=NONE ctermbg=152 cterm=NONE guifg=NONE guibg=#bbd5dc gui=NONE
...
hi NonText ctermfg=223 ctermbg=231 cterm=NONE guifg=#f3d2b3 guibg=#f5f5f5 gui=NONE
...
hi SpecialKey ctermfg=223 ctermbg=188 cterm=NONE guifg=#f3d2b3 guibg=#ebebeb gui=NONE
